...
class ComProtocolMessage
{
	 ...
	 */
	explicit ComProtocolMessage(const com_msg_hdr header, const QByteArray &payload);
	/***
	 ...
	 * @param payload Payload data for the message.
	 */
	explicit ComProtocolMessage(const uint8_t msg_name, const uint8_t msg_type,
