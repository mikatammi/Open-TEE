...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), ui_(new Ui::MainWindow), tui_widget_(new TrustedUIWidget)
{
	ui_->setupUi(this);
	...
	connect(tui_widget_.data(), SIGNAL(statusMessage(const QString &)), this,
...
void MainWindow::showStatusBarMessage(const QString &msg) { ui_->statusBar->showMessage(msg); }
