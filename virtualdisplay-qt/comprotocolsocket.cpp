...
ComProtocolSocket::ComProtocolSocket(QObject *parent) : QObject(parent), socket_(this)
{
...
ComProtocolSocket::~ComProtocolSocket() { stop(); }
...
bool ComProtocolSocket::sendMessage(const ComProtocolMessage &msg)
{
	...
	com_transport_info info{calculateChecksum(msg.getRawData()), COM_MSG_START,
