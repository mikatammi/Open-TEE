...
size_t M_BufferGetCapacity(buf_t *buf) { return buf->capacity; }

size_t M_BufferGetSize(buf_t *buf) { return buf->size; }

size_t M_BufferGetCursor(buf_t *buf) { return buf->cursor; }

char *M_BufferGetData(buf_t *buf) { return buf->data; }

char *M_BufferGetDataAtCursor(buf_t *buf) { return buf->data + buf->cursor; }
...
void M_BufferEnsureCapacity(buf_t *buf, size_t capacity)
{
	...
	if (buf->capacity < needed_capacity) {
		...
		if (buf->data == NULL) {
			error_and_exit("M_BufferEnsureCapacity: Reallocating buffer data failed");
		}
...
{
	M_BufferWrite(dst, M_BufferGetDataAtCursor(src),
...
uint8_t M_BufferPeek(buf_t *buf) { return *(buf->data + buf->cursor); }
...
void M_BufferWriteBool(buf_t *buf, bool b) { M_BufferWriteBools(buf, &b, 1); }
...
void M_BufferWriteChar(buf_t *buf, char c) { M_BufferWriteChars(buf, &c, 1); }
...
void M_BufferWriteShort(buf_t *buf, short s) { M_BufferWriteShorts(buf, &s, 1); }
...
void M_BufferWriteUShort(buf_t *buf, unsigned short s) { M_BufferWriteUShorts(buf, &s, 1); }
...
void M_BufferWriteInt(buf_t *buf, int i) { M_BufferWriteInts(buf, &i, 1); }
...
void M_BufferWriteUInt(buf_t *buf, unsigned int s) { M_BufferWriteUInts(buf, &s, 1); }
...
void M_BufferWriteLong(buf_t *buf, int64_t l) { M_BufferWriteLongs(buf, &l, 1); }
...
void M_BufferWriteULong(buf_t *buf, uint64_t l) { M_BufferWriteULongs(buf, &l, 1); }
...
void M_BufferWriteFloat(buf_t *buf, float f) { M_BufferWriteFloats(buf, &f, 1); }
...
void M_BufferWriteDouble(buf_t *buf, double d) { M_BufferWriteDoubles(buf, &d, 1); }
...
bool M_BufferReadBool(buf_t *buf, bool *b) { return M_BufferReadBools(buf, b, 1); }
...
bool M_BufferReadChar(buf_t *buf, char *c) { return M_BufferReadChars(buf, c, 1); }
...
bool M_BufferReadUChar(buf_t *buf, unsigned char *c) { return M_BufferReadUChars(buf, c, 1); }
...
bool M_BufferReadShort(buf_t *buf, short *s) { return M_BufferReadShorts(buf, s, 1); }
...
bool M_BufferReadUShort(buf_t *buf, unsigned short *s) { return M_BufferReadUShorts(buf, s, 1); }
...
bool M_BufferReadInt(buf_t *buf, int *i) { return M_BufferReadInts(buf, i, 1); }
...
bool M_BufferReadUInt(buf_t *buf, unsigned int *i) { return M_BufferReadUInts(buf, i, 1); }
...
bool M_BufferReadLong(buf_t *buf, int64_t *l) { return M_BufferReadLongs(buf, l, 1); }
...
bool M_BufferReadULong(buf_t *buf, uint64_t *l) { return M_BufferReadULongs(buf, l, 1); }
...
bool M_BufferReadFloat(buf_t *buf, float *f) { return M_BufferReadFloats(buf, f, 1); }
...
bool M_BufferReadDouble(buf_t *buf, double *d) { return M_BufferReadDoubles(buf, d, 1); }
...
void M_BufferZero(buf_t *buf) { memset(buf->data, 0, buf->capacity); }
