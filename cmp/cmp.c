...
bool cmp_read_sinteger(cmp_ctx_t *ctx, int64_t *d) { return cmp_read_long(ctx, d); }
...
bool cmp_read_uinteger(cmp_ctx_t *ctx, uint64_t *d) { return cmp_read_ulong(ctx, d); }
...
bool cmp_object_is_sinteger(cmp_object_t *obj) { return cmp_object_is_long(obj); }
...
bool cmp_object_is_uinteger(cmp_object_t *obj) { return cmp_object_is_ulong(obj); }
...
bool cmp_object_as_sinteger(cmp_object_t *obj, int64_t *d) { return cmp_object_as_long(obj, d); }
...
bool cmp_object_as_uinteger(cmp_object_t *obj, uint64_t *d) { return cmp_object_as_ulong(obj, d); }
