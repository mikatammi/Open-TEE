...
typedef enum { TEE_TUI_NUMERICAL = 0, TEE_TUI_ALPHANUMERICAL } TEE_TUIEntryFieldType;

typedef enum { TEE_TUI_PORTRAIT = 0, TEE_TUI_LANDSCAPE } TEE_TUIScreenOrientation;
